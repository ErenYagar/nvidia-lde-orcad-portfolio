...
| PWR-005 | 若 slot power、thermal 或 transient Gate 不通過，應限制支援 SSD 清單 | Safety／Product | 防止 overclaim | [supported SSD policy](../validation/supported_ssd_policy.md)、release checklist 與 per-device evidence | `Planned` |
